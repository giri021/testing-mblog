        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('backend/settings');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Settings</p></a></li>
                        <?php else:?>
                        <?php endif;?>
            ...
            <div class="page-inner">
                ...
                <div class="page-footer">
                    <p class="no-s"><?php echo date('Y');?> &copy; Powered by Agustinus Giri Hartono.</p>
                </div>
            </div><!-- Page Inner -->
        </main><!-- Page Content -->
